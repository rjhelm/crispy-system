...
const Header = () => {
    ...
    return (
        <header className='bg-primary-purple fixed top-0 py-2.5 w-full z-10'>
            {/* { Nav Container } */}
            <div className="w-full sm:w-9/12 px-1 sm:px-4 m-auto flex justify-between items-center relative">
                {/* { Logo and Search Cont. } */}
                <div className="flex items-center flex-1">
                    <Link className="h-7 mr-1 sm:mr-4" to="/">
                        <img draggable="false" className="h-full w-full object-contain" src={" "} alt="RyanJDev Logo" />
                    </Link>
                ...
                <div className='flex items-center justify-between ml-1 sm:ml-0 gap-0.5 sm:gap-7 relative'>
                    ...
                    {toggleSecondaryDropDown && <PrimaryDropDownMenu setTogglePrimaryDropDown={setTogglePrimaryDropDown} user={user} />}
