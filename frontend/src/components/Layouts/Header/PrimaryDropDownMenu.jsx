...
const PrimaryDropDownMenu = ({ setTogglePrimaryDropDown, user }) => {
    ...
    return (
        <div className="absolute w-60 -left-24 ml-2 top-9 bg-gray shadow-2x1 rounded flex-col text-sm">
            {user.role === 'admin' &&
                <Link className="p1-3 py-3.5 border-b flex gap-3 items-center hover:bg-blue-50 rounded-t" to='/admin/dashboard'>
                    <span className="text-primary-black"><DashboardIcon sx={{ fontSize: "18px" }} /></span>
                </Link>
            }
