...
const ProductDetails = () => {
    ...
    const itemInWishlist = wishlistItems.some((i) => i.product === product.id);

    const addToWishlistHandler = () => {
        if (itemInWishlist) {
            dispatch(removeFromWishlist(productId));
            enqueueSnackbar("Removed from your wishlist", { variant: "success" });
        } else {
                ...
                <div className="w-full flex flex-col sm:flex-row bg-white sm:p-2 relative">
                    ...
                    <div className="flex-1 py-2 px-3">
                        <div className="flex flex-col gap-2 mb-4">
                            <h2 className="text-x1">{product.name}</h2>
                            {/* {Rating Badge} */}
                            ...
                            {/* {Price} */}
                            <span className="text-primary-green text-sm font-medium">Price</span>
                            <div className="flex items-baseline gap-2 text-3x1 font-medium">
                            ...
                            <div className="flex flex-col sm:flex-row justify-between">
                                ...
                                <div className="flex gap-16 mt-4 mr-6 items-stretch text-sm">
                                    ...
                                    <ul className="flex flex-col gap-2">
                                        <li>
                                            <p className="flex items-center gap-3"><span className="text-primary-blue"><VerifiedUserIcon sx={{ fontSize: '18px' }} /></span></p>
                                        </li>
                                        <li>
                            ...
                            <div className="flex gap-16 mt-4 items-center text-sm font-medium">
                                ...
                                <Link className="font-medium text-primary-blue m1-3" to='/'>{product.brand && product.brand.name}</Link>
                            </div>

                            {/* {RyanJDev Banner} */}
                            <div className="sm:w-1/2 mt-4 border">
                                <img draggable="false" className="w-full h-full object-contain" src="" alt="" />
                            </div>
                            ...
                            <div className="w-full mt-4 pb-4 rounded-sm border flex flex-col">
                                <h1 className="px-6 py-4 border-b text-2x1 font-medium">Specifications</h1>
